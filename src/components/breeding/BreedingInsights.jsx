...
export default function BreedingInsights({ analytics }) {
        ...
        <CardContent sx={{ p: 3 }}>
          <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 1.5 }}>
            ...
            <Typography variant="subtitle1" fontWeight={700} color="text.primary">
              Breeding AI Insights
            </Typography>
          </Stack>
          <Divider sx={{ mb: 2.5 }} />
          <Typography color="text.secondary" variant="body2">
            Add breeding records to receive intelligent recommendations.
          </Typography>
        </CardContent>
      </Card>
    );
...
function SummarySection({ analytics }) {
  return (
    <Stack spacing={1.5}>
      ...
      <Stack spacing={1}>
        <SummaryRow icon={<FavoriteIcon sx={{ fontSize: 18, color: "error.light" }} />} label="Ready for Breeding" value={analytics.readyForBreeding} />
        <SummaryRow icon={<PregnantWomanIcon sx={{ fontSize: 18, color: "info.main" }} />} label="Pregnant Animals" value={analytics.pregnantAnimals} />
        <SummaryRow icon={<AssignmentIcon sx={{ fontSize: 18, color: "warning.main" }} />} label="Pregnancy Checks Due" value={analytics.pregnancyChecksDue} />
        <SummaryRow icon={<ChildFriendlyIcon sx={{ fontSize: 18, color: "success.main" }} />} label="Expected Births" value={analytics.expectedBirths} />
        <SummaryRow icon={<TrendingUpIcon sx={{ fontSize: 18, color: "secondary.main" }} />} label="Births This Month" value={analytics.birthsThisMonth} />
      </Stack>
    </Stack>
  );
}
